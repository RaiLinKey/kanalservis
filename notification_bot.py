...
# функция получения списка отправленных уведомлений
...
# функция занесения отметки об отправленном сообщении
...
# функция добавления нового пользователя к рассылке
...
# функция запуска отправки сообщений, тем кто подписан
